...
void Nord::brawl()
{
	...
	int acceptRoll = curTarget->combatRoll() + curTarget->getCombatSkill() / 2;
	...
	{
		cout << getName() << ": Shor's bones, what a fight that was! You fought well, " << curTarget->getName() << "." << endl;
	...
	else
	{
		...
		cout << loser->getName() << ": Alright alright I concede! No more! Take your winnings and leave, " << winner->getName() << "!" << endl;
